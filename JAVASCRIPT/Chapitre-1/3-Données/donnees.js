...
let string3 = `la voiture à ${number} kilométres ` // Si j'utilise les accents grave pour déclarer une chaine de caractère je dois utiliser un littéral de gabarit pour déclarer l'utilisation d'une variable dans la chaine de caractère
